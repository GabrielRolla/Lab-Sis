...
const float MARGEM_DETECCAO = 1500.0f;
const float LIMIAR_MINIMO_VOZ = 1500.0f;
...
uint8_t lerNivelVozINMP441() {
  ...
  float limiarAdaptativo = ruidoFundo + MARGEM_DETECCAO;
  if (limiarAdaptativo < LIMIAR_MINIMO_VOZ) {
    limiarAdaptativo = LIMIAR_MINIMO_VOZ;
  }
